<div class="icon_container">
    <a href="https://wa.me/919211241314" target="_blank" rel="noopener">
        <img src="<?= base_url()?>assets/images/whatsapp.png" alt="WhatsApp" class="whatsappIcon" />
    </a>
</div>
<div class="mains_class_up_heads">
    <div class="header_sections_mains">
        <div class="container" style="background-image: url(<?= base_url()?>assets/images/Mask.png)">
            <div class="left-section">
                <div class="owl-carousel owl-carousel-A owl-carousel-A owl-theme" id="owl-carousel-A">
                    <div class="item">
            ...
            <div class="right-section">
                <div class="content">
                    <h1 class="main_head_pandit">
                        NEED A PANDITJI
                        <span class="highlight">FOR POOJA <span class="needs">NEEDS</span></span>
                    </h1>
                    <p>We get it solved for you!</p>
                    <div class="buttons">
                        <button class="btn bttns btn-primary" onclick="openbooking()">
                            <img src="<?= base_url()?>assets/images/ico-pandit.png" alt="icons" style="width: 25px" />
                            BOOK NOW
                        </button>
                        <button class="btn bttns btn-secondary" onclick="openconsultmodal()">
                            <img src="<?= base_url()?>assets/images/free.png" alt="icons" style="width: 25px" />
                            CONSULTATION
                        </button>
                    </div>
                </div>
...
<section class="top_pandit_list" style="background-image: url(<?= base_url()?>assets/images/Union.png)">
    <div class="mains_pandit_section">
        <div class="pandit_section_header">
            <div class="pandit_header_left">
                <img src="<?= base_url()?>assets/images/abtop.png" alt="top_bar" />
            ...
            <div class="pandit_cards_new owl-carousel owl-carousel-B owl-theme" id="owl-carousel-B">
                <div class="pandi_cards">
                    ...
                    <div class="card_widhlist">
                        <a href="#" class="wishlist-icon"><img src="<?= base_url()?>assets/images/wishlist_cards.png"
                                alt="Wishlist" />
                        </a>
                    </div>
                    <div class="pandit_content">
                        ...
                        <button class="btn btn-primary book_now" onclick="openbooking()" type="button">
                            BOOK NOW
                        </button>
                    </div>
                </div>
...
<section class="video_section" style="background-image: url(<?= base_url()?>assets/images/mainvideo.png)">
    <div class="video_section_main">
        <div class="videos_play">
            <img class="play_button" id="customPlayBtn" src="<?= base_url()?>assets/images/Playbutton.png"
                alt="Play Button" />
            <video class="main_plays" id="video1" controls controlsList="nodownload">
...
<section class="top_pandit_list" style="background-image: url(<?= base_url()?>assets/images/Union.png)">
    <div class="mains_pandit_section main_products_section">
        ...
        <div class="crausel_cards">
            <div class="pandit_cards_new owl-carousel owl-carousel-C owl-theme" id="owl-carousel-C">
                <div class="pandi_cards">
                    <div class="pandit_images">
                    ...
                    <div class="pandit_content">
                        ...
                        <div class="main_carts">
                            ...
                            <button class="btn btn-primary add_now" type="button"
                                onclick="addToCart('Product Name', 95, 'assets/images/cart1.png')">
                                <img src="<?= base_url()?>assets/images/carti.png" alt="icons" style="width: 20px" />
                                Add
                            </button>
                        </div>
                    </div>
        ...
        <div class="sectiion_process">
            ...
            <div class="process_right">
                ...
                <div class="process_steps">
                    ...
                    <div class="step">
                        <div class="step-icon">
                            <img src="<?= base_url()?>assets/images/step2.png" class="step_again" alt="step1" />
                        </div>
                    ...
                    <div class="step">
                        <div class="step-icon">
                            <img src="<?= base_url()?>assets/images/step3.png" class="step_again" alt="step1" />
                        </div>
                        <div class="step-content step_content_new">
                    ...
                    <div class="step">
                        <div class="step-icon">
                            <img src="<?= base_url()?>assets/images/step4.png" class="step_again" alt="step1" />
                        </div>
                        <div class="step-content step_content_new">
...
<section class="testomonials_section" style="background-image: url(<?= base_url()?>assets/images/parallax1.png)">
    <div class="mains_testominal">
        ...
        <div class="testomoinals_review">
            <div class="testomoials_carousel owl-carousel owl-carousel-A owl-theme" id="owl-carousel-D">
        ...
        <div class="news_letter_updates">
            ...
            <div class="news_leeter_right">
                <div class="news_letter_input">
                    <input type="email" class="news_input" id="exampleInputEmail1" aria-describedby="emailHelp"
