...
<<<<<<< HEAD
            <div class="about_left_sections">
                <div class="pandit_header_left">
                    ...
                    <h5>Contact Us</h5>
                    <h3 class="mains_con" style="font-weight: 700; line-height: 50px; font-size: 45px">
                        Have a Question ? <br />
                    ...
                    <div class="main_contact_us">
                        <div class="main_contact_section">
                            ...
                            <button type="button" class="btn btn-primary submit_button read_more">
                                SUBMIT
                    ...
                    <div class="rights_cont_updates">
                        ...
                        <div class="right_updates_new">
                            <div class="social_icons">
                                <a href="https://www.facebook.com/profile.php?id=61565781186435" target="_blank"><i
                                        class="fa-brands fa-facebook-f"></i></a>
                                <a href="https://www.instagram.com/pujaridekho/" target="_blank"><i
                                        class="fa-brands fa-instagram"></i></a>
                                <a href="https://www.youtube.com/@PujariDekho" target="_blank"><i
                                        class="fa-brands fa-youtube"></i></a>
                                <a href="https://pujaridekho.com/" target="_blank"><i
...
<section class="contact_section_map">
    <div class="main_contact_map">
        <div class="main_locations">
            <div class="map_con">
                <iframe width="1320" height="540" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
                    id="gmap_canvas"
                    src="https://maps.google.com/maps?width=1000&amp;height=520&amp;hl=en&amp;q=D77%20f01%20sector%2063%20noida%20%20+(Pujaridekho)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                <a href="https://www.acadoo.de/leistungen/ghostwriter-doktorarbeit/">Doktorarbeit schreiben
                    Unterstützung</a>
            </div>
        </div>
    </div>
