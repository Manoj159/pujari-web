...
function addPandit(){
    formData = document.getElementById('addNewPandit');
    $.ajax({
        type: "POST",
        url: "/admin/addpandit",
        ...
        error: function (xhr, status, error) {
            alert('Error adding pandit: ' + xhr.responseText);
        }
    });
}
...
function addPooja(){
    formData = document.getElementById('addNewPooja');
    $.ajax({
        type: "POST",
        url: "/admin/addpooja",
        data: new FormData(formData),
        ...
        error: function (xhr, status, error) {
            alert('Error adding pooja: ' + xhr.responseText);
        }
    });
}